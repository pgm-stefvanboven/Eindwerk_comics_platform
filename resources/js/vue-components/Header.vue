  ...
  <header class="bg-yellow-600 py-4">
    <div class="container">
      <nav class="max-w-screen-2xl mx-auto flex items-center justify-between">
        <h1 class="text-3xl font-bold text-white"><a href="/" class="hover:text-yellow-300">Marvel Comic Universe</a>
        </h1>
        ...
        <ul class="flex space-x-4 text-white">
          ...
          <li><router-link to="/wishlist" class="text hover:text-yellow-300">Wishlist</router-link></li>
        </ul>
      </nav>
    </div>
  </header>
